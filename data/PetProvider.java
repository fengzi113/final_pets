...
public class PetProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI
                (PetContract.CONTENT_AUTHORITY, PetContract.PATH_PETS, PETS);
        sUriMatcher.addURI
                (PetContract.CONTENT_AUTHORITY, PetContract.PATH_PETS + "/#", PET_ID);
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        if (gender == null || !PetContract.PetEntry.isValidGender(gender)) {
            ...
            Toast.makeText(getContext(), "Pet requires valid gender", Toast.LENGTH_SHORT).show();
        ...
        if (weight != null && weight < 0) {
            Toast.makeText(getContext(), "Pet requires valid weight", Toast.LENGTH_SHORT).show();
        }
